...
namespace EF_Odev.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<KategoriIsimleri> KategoriIsimleris { get; set; } = null!;
        ...
        public virtual DbSet<Ornekview> Ornekviews { get; set; } = null!;
        public virtual DbSet<Personel> Personels { get; set; } = null!;
        public virtual DbSet<Product> Products { get; set; } = null!;
        public virtual DbSet<ProductName> ProductNames { get; set; } = null!;
        public virtual DbSet<ProductNameEncryption> ProductNameEncryptions { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=GHOST2023\\SQLEXPRESS;Database=Northwind;Trusted_Connection=True;MultipleActiveResultSets=true;TrustServerCertificate=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<KategoriIsimleri>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("KategoriIsimleri");
            ...
            modelBuilder.Entity<Ornekview>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ornekview");
            ...
            modelBuilder.Entity<ProductNameEncryption>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ProductName_encryption");
